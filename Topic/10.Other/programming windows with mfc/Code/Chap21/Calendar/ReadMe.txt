========================================================================
		ActiveX Control DLL : CALENDAR
========================================================================

ControlWizard has created this project for your CALENDAR ActiveX Control
...
that make up your CALENDAR ActiveX Control DLL.
...
CalendarCtl.h
	This file contains the declaration of the CCalendarCtrl C++ class.

CalendarCtl.cpp
	This file contains the implementation of the CCalendarCtrl C++ class.

CalendarPpg.h
	This file contains the declaration of the CCalendarPropPage C++ class.

CalendarPpg.cpp
	This file contains the implementation of the CCalendarPropPage C++ class.

CalendarCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCalendarCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Calendar.rc.
