...
public class Server implements Runnable {
   ...
   public final static Server tcpObj = new Server ();
   ...
   // truyen gia tri cho connectionStatus
   public static String statusString = statusMessages[1];
   
   public static StringBuffer toAppend = new StringBuffer("");
   public static StringBuffer toSend = new StringBuffer("");

   // KHoi tao bien GUI component
 ...
 //  public static JRadioButton guestOption = null;
   ...
   // Thay đổi trạng thái kết nối
   private static void changeStatusTS(int newConnectStatus, boolean noError) {
      // Thay đổi trạng thái khi hợp lệ
      if (newConnectStatus != NULL) {
         connectionStatus = newConnectStatus;
      }

      // Trạng thái khi có k0 có lỗi
      if (noError) {
   ...
   // tạo sự thống nhất button/textfield
      ipField.setText(hostIP);
      portField.setText((new Integer(port)).toString());
  ...
  //    guestOption.setSelected(!isHost);
   ...
   public static void main(String args[]) {
      ...
      while (true) {
            ...
            try {
               ...
               if (in.ready()) {
                  ...
                  if ((s != null) &&  (s.length() != 0)) {
                     //Kiểm tra kết thúc của 1 đường truyền
                     if (s.equals(END_CHAT_SESSION)) {
                        changeStatusTS(DISCONNECTING, true);
                     }

                     else {
                        appendToChatBox("Receiving: " + s + "\n");
                        changeStatusTS(NULL, true);
                     }
                  }
               }
         ...
         case DISCONNECTING:
            // Thông báo kết nối khác để ngắt kết nối
            out.print(END_CHAT_SESSION); out.flush();

            //Clean all streams/sockets
            cleanUp();
