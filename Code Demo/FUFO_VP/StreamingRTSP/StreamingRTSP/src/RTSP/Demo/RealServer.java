...
public class RealServer {
    ...
    public static void main(String argv[]) throws Exception
    {
      ...
      RealServer theServer = new RealServer();
...
/*      //get server RTSP port and IP address from the command line
      ...
      VideoFileName = "D:\\movie.Mjpeg" ;
         // VideoFileName = "/sdcard/movie.Mjpeg";

      // get RTSP socket port from the command line
      int RTSPport = Integer.parseInt("26000");
     ...
     // theServer.RTSPsocket = new Socket(ServerIPAddr, RTSP_server_port);
